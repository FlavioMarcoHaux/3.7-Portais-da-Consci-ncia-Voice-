...
export const getFriendlyErrorMessage = (error: any, defaultMessage: string): string => {
    ...
    // 3. Handle specific string-based errors that require user action (API Key/Billing)
    if (
    ...
    // 4. Handle other common, non-blocking errors
    ...
    // 5. Return default if no specific case matched
